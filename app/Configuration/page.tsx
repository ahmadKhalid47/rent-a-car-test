          ...
          <div className="w-full h-fit mt-4">
            <div className="w-full h-fit flex justify-between flex-wrap items-start gap-y-4 p-4 rounded-[10px] border-[1px] border-grey dark:bg-dark bg-light-grey mt-2">
              {configArray.map((item) => (
                <Link
                  href={item.href}
                  className="card w-[100%] lg:w-[18.50%] h-[155px] dark:bg-dark1 bg-white rounded-[10px] border-[1px] border-grey px-0 md:px-5 lg:px-2 1400:px-5 py-2 xs:py-5 flex justify-center gap-3 md:gap-3 lg:gap-4 items-center relative flex-col list-hover"
                >
