...
export default function Generalreservation() {
  let { reservationInfo } = useSelector((state: RootState) => state.reservationInfo);
  ...
  let ImageArray =
    activeField === "passport"
      ? reservationInfo?.passportImages
      : reservationInfo?.licenseImages;

  let imageLength =
    activeField === "passport"
      ? reservationInfo.passportImages?.length
      : reservationInfo.licenseImages?.length;
