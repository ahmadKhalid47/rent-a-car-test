...
const ReservationChauffeurInfo = () => {
  return (
    <div className="w-full flex justify-between items-center  px-[70px] py-[20px] ">
      ...
      <div className="w-1/2">
        <div className=" w-full flex justify-between ">
          ...
          <div className="font-[400] text-[18px]">Glenn A. Jean</div>
        </div>
        ...
        <div className=" w-full flex justify-between ">
          ...
          <div className="font-[400] text-[18px]">757-947-5015</div>
        </div>
        <div className="border border-t mt-2 mb-2"></div>
        <div className=" w-full flex justify-between ">
          <div className="font-[400] text-[18px]">City:</div>
          <div className="font-[400] text-[18px]">Brentwood</div>
        </div>
        <div className="border border-t mt-2 mb-2"></div>
        <div className=" w-full flex justify-between ">
          <div className="font-[400] text-[18px]">Country:</div>
          <div className="font-[400] text-[18px]">USA</div>
        </div>
      </div>
      <div className="">
...
export default ReservationChauffeurInfo;
