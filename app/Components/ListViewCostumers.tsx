...
export default function ListViewCostumers() {
  return (
    <div className="w-full h-fit mt-4">
      ...
      <div className="w-full h-fit flex flex-col justify-start items-start rounded-[10px] bg-light-grey border-2 border-grey overflow-hidden mt-2 leading-[17px]">
        <div className="w-full h-[43px] flex justify-between items-center font-[600] text-[14px] rounded-t-[10px] leading-[17px text-center border-b-2 border-grey">
          ...
          <div className="text-start pe-3 flex justify-between items-center w-[14%] ps-7">
        ...
        >
          ...
          <h5 className="text-start pe-3 w-[14%] ps-[10px]">539485</h5>
          <div className="flex justify-start item-center gap-5 text-start pe-3 w-[20%]">
            Glenn A. Jean
            {/* <img src={vip.src} /> */}
          </div>
          <h5 className="text-start pe-3 w-[13%]">Individual</h5>
          <h5 className="text-start pe-3 w-[11%]">757-947-5015</h5>
